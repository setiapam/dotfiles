...
map("n", "<C-A-a>", "ggVG", { desc = "selection Select all" })
map("n", "<C-A-c>", "<cmd> %y+ <CR>", { desc = "general Copy whole file to clipboard" })
...
map("n", "<C-p>", "<cmd> Telescope find_files hidden=true no_ignore=true<CR>", { desc = "Telescope Find files" })
